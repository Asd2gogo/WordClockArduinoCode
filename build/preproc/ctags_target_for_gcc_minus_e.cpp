...
//#include <zip.h>
# 10 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino" 2
# 11 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino" 2
# 12 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino" 2

//------------------------WEB Server-----------------------------------------
# 15 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino" 2
# 16 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino" 2
# 17 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino" 2
...
public:
  ...
  CRGB* getLEDatXY(int x, int y){
      ...
      int x0;
       x0 = 225 -(15*(y + 1)); // set x0 corrosponding to current y row
      if(isRLrow){
...
class WordController
{
  ...
  { // return array of possible word combination to for given time
    ...
    /*
      ...
      */
# 636 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino"
    return returnVector;
  }
};
...
class Animation
{
  ...
  bool tick()
  {
    ...
    if (perzentageTimePassed > lastPerzentagTimePassed)
    {
      ...
      */
# 771 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino"
...
*/
# 1120 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino"
  "<!DOCTYPE html><html lang='de'><head>"
    "<meta name='viewport' content='width=device-width'>"
    "<style>"
        "li{"
    ...
    */
# 1156 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino"
   " <li>"
        "<input type=\"submit\" value=\"Ok\">"
    "</li>"
    "</ul>"
...
void handleTimeForm(){
  ...
  wordColor = CRGB((int) strtoll(&_wordColor[1],__null, 16));
  backgroundColor = CRGB((int) strtoll(&_backgroundColor[1],__null, 16));
...
void loop()
{
  ...
  if(lastIncrease + 1100 < millis()){
    ...
    */
# 1282 "c:\\Users\\Sven Weinert\\OneDrive - Sennheiser electronic GmbH & Co. KG\\Projekte\\WordClock\\Arduino\\LEDController\\LEDController.ino"
    //setLedForTime(m, h, s);
